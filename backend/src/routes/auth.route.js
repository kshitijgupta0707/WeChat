...
import { checkAuth, login, logout, signup, updateProfile, sendOtp, loginwithOAuth } from "../controllers/auth.controller.js";
...
authRoutes.post("/loginwithOAuth", loginwithOAuth);
